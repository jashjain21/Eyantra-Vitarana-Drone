...
class Edrone():
    ...
    def __init__(self):
        ...
        #kp corresponds in order of pitch roll and throttle
        self.Kp = [12.24, 18.84]
        self.Ki = [0.000001 , 0.000002]
        self.Kd = [ 28000*10,10000*11 ]
        self.error = [0.0,0.0,0.0]  #errors in each axis
        self.prev_error = [0.0, 0.0] #previous errors in each axis
        self.fix_lat = 19.0
        self.fix_lon = 72.0
        self.fix_alt=  3.0   #PUT ALTITUDE HERE
        self.out_roll = 0.0
        self.out_pitch = 0.0
    ...
    def pid(self):
     ...
     #///////////// MAKE SOME CHANGES HERE/////////////////// TO MAKE IT MOVE FROM ONE PLACE TO ANOTHER
      ...
      #  self.errSum[1] = self.errSum[1] + (self.error[1] * self.sample_time)
        ...
        self.drone_cmd.rcThrottle=self.fix_alt

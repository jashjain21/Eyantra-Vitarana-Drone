...
class Edrone():
    ...
    def __init__(self):
        ...
        self.Kp = [5.22, 4.0, 200.0, 0.54]
        self.Ki = [0.0, 0.0, 0.0, 0.000054]
        self.Kd = [1454 , 1382.0, 3000.0, 823.5]
      ...
      #  self.z_pub = rospy.Publisher('/z_mark', Float32, queue_size=1)
    ...
    def altitude_set_pid(self, altitude):
        ...
        self.Ki[3] = altitude.Ki * 0.00000001
    ...
    def pid(self):
      ...
      #  Convertng the range from 1000 to 2000 in the range of -10 degree to 10 degree for roll axis
        ...
        self.out_base =  500 + self.out_throttle*100
